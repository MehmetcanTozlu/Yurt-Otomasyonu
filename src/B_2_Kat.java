...
public class B_2_Kat extends javax.swing.JFrame {
    OgrenciIslemleri islemler = new OgrenciIslemleri();
    DefaultTableModel model;
    /**
     * Creates new form B_2_Kat
     */
    public B_2_Kat(java.awt.Frame parent, boolean modal) {
        initComponents();
        model = (DefaultTableModel)b_2_tablo.getModel();
        OgrenciGoruntule();
    }
    ...
    private void initComponents() {
        ...
        b_2_tablo = new javax.swing.JTable();
        ...
        b_2_kat_arkaplan = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("B Blok 2. Kat İşlemleri");
        ...
        b_2_tablo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        b_2_tablo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                b_2_tabloMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(b_2_tablo);
        if (b_2_tablo.getColumnModel().getColumnCount() > 0) {
            b_2_tablo.getColumnModel().getColumn(0).setResizable(false);
            b_2_tablo.getColumnModel().getColumn(1).setResizable(false);
            b_2_tablo.getColumnModel().getColumn(2).setResizable(false);
            b_2_tablo.getColumnModel().getColumn(3).setResizable(false);
            b_2_tablo.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        b_2_kat_arkaplan.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        b_2_kat_arkaplan.setForeground(new java.awt.Color(255, 0, 51));
        b_2_kat_arkaplan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yurt_arkaplan.jpg"))); // NOI18N
        jPanel1.add(b_2_kat_arkaplan);
        b_2_kat_arkaplan.setBounds(0, 0, 800, 533);
    ...
    private void b_2_tabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_2_tabloMouseClicked
        int selectedrow = b_2_tablo.getSelectedRow();
    ...
    }//GEN-LAST:event_b_2_tabloMouseClicked
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        islemler.ogrenciGuncelle4(ad,soyad,oda,yatak,sira);
        OgrenciGoruntule();
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        islemler.ogrenci5Ekle(ad, soyad, oda, yatak);
        OgrenciGoruntule();
    ...
    public void OgrenciGoruntule(){
        ...
        proje = islemler.B2araOgrencileriGetir();
        if(proje !=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(B_2_Kat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                B_2_Kat dialog = new B_2_Kat(new javax.swing.JFrame(), true);
    ...
    javax.swing.JLabel b_2_kat_arkaplan;
    javax.swing.JTable b_2_tablo;
