...
public class A_2_Kat extends javax.swing.JFrame {
    OgrenciIslemleri islemler = new OgrenciIslemleri();
    DefaultTableModel model;
    /**
     * Creates new form A_2_Kat
     */
    public A_2_Kat(java.awt.Frame parent, boolean modal) {
        initComponents();
        model = (DefaultTableModel)a_2_tablo.getModel();
        OgrenciGoruntule();
    }
    /**
    ...
    private void initComponents() {
        ...
        a_2_tablo = new javax.swing.JTable();
        ...
        a_2_kat_arkaplan = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("A Blok 2. Kat İşlemleri");
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(70, 70, 50, 30);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Oda :");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(70, 110, 70, 30);
        ...
        a_2_tablo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        a_2_tablo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                a_2_tabloMouseClicked(evt);
            }
        });
        a_2_tablo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                a_2_tabloKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(a_2_tablo);
        if (a_2_tablo.getColumnModel().getColumnCount() > 0) {
            a_2_tablo.getColumnModel().getColumn(0).setResizable(false);
            a_2_tablo.getColumnModel().getColumn(1).setResizable(false);
            a_2_tablo.getColumnModel().getColumn(2).setResizable(false);
            a_2_tablo.getColumnModel().getColumn(3).setResizable(false);
            a_2_tablo.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        a_2_kat_arkaplan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yurt_arkaplan.jpg"))); // NOI18N
        jPanel1.add(a_2_kat_arkaplan);
        a_2_kat_arkaplan.setBounds(0, 0, 800, 533);
    ...
    private void a_2_tabloKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_a_2_tabloKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_a_2_tabloKeyReleased

    private void a_2_tabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_a_2_tabloMouseClicked
        int selectedrow = a_2_tablo.getSelectedRow();
    ...
    }//GEN-LAST:event_a_2_tabloMouseClicked
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        islemler.ogrenci2Ekle(ad, soyad, oda, yatak);
        OgrenciGoruntule();
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        int sira = (int) model.getValueAt(selectedrow, 0);
        islemler.ogrenciGuncelle1(ad,soyad,oda,yatak,sira);
        OgrenciGoruntule();
    ...
    public void OgrenciGoruntule(){
        ...
        proje = islemler.A2araOgrencileriGetir();
        if(proje !=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A_2_Kat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                A_2_Kat dialog = new A_2_Kat(new javax.swing.JFrame(), true);
    ...
    javax.swing.JLabel a_2_kat_arkaplan;
    javax.swing.JTable a_2_tablo;
