...
public class B_3_Kat extends javax.swing.JFrame {
    OgrenciIslemleri islemler = new OgrenciIslemleri();
    DefaultTableModel model;
    /**
     * Creates new form B_3_Kat
     */
    public B_3_Kat(java.awt.Frame parent, boolean modal) {
        initComponents();
        model = (DefaultTableModel)b_3_tablo.getModel();
        OgrenciGoruntule();
    }
    ...
    private void initComponents() {
        ...
        b_3_tablo = new javax.swing.JTable();
        ...
        b_3_kat_arkaplan = new javax.swing.JLabel();
        ...
        setTitle("B Blok 3. Kat İşlemleri");
        ...
        b_3_tablo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        b_3_tablo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                b_3_tabloMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(b_3_tablo);
        if (b_3_tablo.getColumnModel().getColumnCount() > 0) {
            b_3_tablo.getColumnModel().getColumn(0).setResizable(false);
            b_3_tablo.getColumnModel().getColumn(1).setResizable(false);
            b_3_tablo.getColumnModel().getColumn(2).setResizable(false);
            b_3_tablo.getColumnModel().getColumn(3).setResizable(false);
            b_3_tablo.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        b_3_kat_arkaplan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yurt_arkaplan.jpg"))); // NOI18N
        jPanel1.add(b_3_kat_arkaplan);
        b_3_kat_arkaplan.setBounds(0, 0, 800, 533);
    ...
    private void silActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_silActionPerformed
        ...
        int selectedrow = b_3_tablo.getSelectedRow();
        if(selectedrow == -1){
    ...
    private void b_3_tabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_3_tabloMouseClicked
        int selectedrow = b_3_tablo.getSelectedRow();
    ...
    }//GEN-LAST:event_b_3_tabloMouseClicked
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        int sira = (int) model.getValueAt(selectedrow, 0);
        islemler.ogrenciGuncelle5(ad,soyad,oda,yatak,sira);
        OgrenciGoruntule();
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        islemler.ogrenci6Ekle(ad, soyad, oda, yatak);
        OgrenciGoruntule();
    ...
    public void OgrenciGoruntule(){
        ...
        proje = islemler.B3araOgrencileriGetir();
        if(proje !=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(B_3_Kat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                B_3_Kat dialog = new B_3_Kat(new javax.swing.JFrame(), true);
    ...
    javax.swing.JLabel b_3_kat_arkaplan;
    javax.swing.JTable b_3_tablo;
