...
public class A_3_Kat extends javax.swing.JFrame {
    OgrenciIslemleri islemler = new OgrenciIslemleri();
    DefaultTableModel model;
    /**
     * Creates new form A_3_Kat
     */
    public A_3_Kat(java.awt.Frame parent, boolean modal) {
        initComponents();
        model = (DefaultTableModel)a_3_tablo.getModel();
        OgrenciGoruntule();
    }
    ...
    private void initComponents() {
        ...
        a_3_tablo = new javax.swing.JTable();
        ...
        a_3_kat_arkaplan = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("A Blok 3. Kat İşlemleri");
        ...
        a_3_tablo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        a_3_tablo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                a_3_tabloMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(a_3_tablo);
        if (a_3_tablo.getColumnModel().getColumnCount() > 0) {
            a_3_tablo.getColumnModel().getColumn(0).setResizable(false);
            a_3_tablo.getColumnModel().getColumn(1).setResizable(false);
            a_3_tablo.getColumnModel().getColumn(2).setResizable(false);
            a_3_tablo.getColumnModel().getColumn(3).setResizable(false);
            a_3_tablo.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        a_3_kat_arkaplan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yurt_arkaplan.jpg"))); // NOI18N
        jPanel1.add(a_3_kat_arkaplan);
        a_3_kat_arkaplan.setBounds(0, 0, 800, 533);
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        int selectedrow = a_3_tablo.getSelectedRow();
        ...
        islemler.ogrenciGuncelle2(ad,soyad,oda,yatak,sira);
        OgrenciGoruntule();
    ...
    private void a_3_tabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_a_3_tabloMouseClicked
        int selectedrow = a_3_tablo.getSelectedRow();
    ...
    }//GEN-LAST:event_a_3_tabloMouseClicked
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        islemler.ogrenci3Ekle(ad, soyad, oda, yatak);
        OgrenciGoruntule();
    ...
    public void OgrenciGoruntule(){
        ...
        proje = islemler.A3araOgrencileriGetir();
        if(proje !=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A_3_Kat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                A_3_Kat dialog = new A_3_Kat(new javax.swing.JFrame(), true);
    ...
    javax.swing.JLabel a_3_kat_arkaplan;
    javax.swing.JTable a_3_tablo;
